...
function SolverPanel() {
  ...
  const solverLabel = solverRunning === null ? 'Checking' : solverRunning ? 'Running' : 'Stopped'
  ...
  return (
    <section>
      ...
      <p className="mt-1 text-sm text-[var(--text-muted)]">
        Customize the execution modes, registration identities and third-party entries each platform supports.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-3">
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Execution mode</p>
