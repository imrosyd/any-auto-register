...
function GeneralTab({
  ...
  return (
    <div className="space-y-8">
      <SettingGroup title="Appearance theme" desc="Choose the app's appearance theme; applies immediately.">
      ...
      >
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          ...
          <SettingRow label="Default execution mode">
            <select
            ...
            <div className="space-y-3 px-4 py-4">
              ...
              {info.latest.published_at && (
                <div className="text-xs text-[var(--text-muted)]">
                  Released {new Date(info.latest.published_at).toLocaleDateString('en-US')}
                </div>
              )}
              <Button
                size="sm"
