...
class WindsurfPlatform(BasePlatform):
    ...
    capabilities = [
        ...
        "generate_link",            # Generate Pro Trial Stripe link (auto-solve captcha)
        "generate_link_browser",    # Generate Pro Trial Stripe link (browser)
        "switch_desktop",           # Switch to desktop app
    ]
    capability_overrides = {
        "generate_link": {
            "label": "Generate Pro Trial link (auto-solve captcha)",
            "params": [
                {"key": "turnstile_token", "label": "Turnstile Token (optional, auto-solve captcha)", "type": "text"},
            ],
        },
    ...
    def _handle_switch_desktop(self, account: Account, params: dict) -> dict:
        ...
        1. Call GetOneTimeAuthToken with session_token -> get OTT
    ...
    def _handle_generate_link_browser(self, account: Account, params: dict) -> dict:
        ...
        if turnstile_token:
            ...
            self.log("No Turnstile token provided, will auto-solve on page")
