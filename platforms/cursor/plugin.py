...
class CursorPlatform(BasePlatform):
    ...
    def build_browser_registration_adapter(self):
        return BrowserRegistrationAdapter(
            ...
            otp_spec=OtpSpec(wait_message="Waiting for Cursor email verification code...", success_label="Verification code"),
    ...
    def get_platform_actions(self) -> list:
        """Return list of operations supported by the platform"""
        return [
        ...
        if action_id == "switch_account":
            ...
            return {
                ...
                "data": {
                    ...
                    "quota_note": "Cursor can query usage, but some accounts only return used amount; maxRequestUsage/maxTokenUsage may be empty, cannot guarantee remaining quota calculation.",
                }
            }
            ...
            if user_info:
                ...
                return {
                    ...
                    "data": {
                        ...
                        "desktop_app_state": get_cursor_desktop_state(),
                    "quota_note": "Cursor can query usage, but some accounts only return used amounts; maxRequestUsage/maxTokenUsage may be empty, remaining quota cannot always be calculated.",
                    },
                }
