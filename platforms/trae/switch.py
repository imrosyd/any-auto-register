"""
Trae.ai account switch - write to local config file, Trae IDE auto-detects
...
def switch_trae_account(
    ...
    """
    Switch Trae account (writes to storage.json, needs Trae restart)
...
def restart_trae_ide() -> Tuple[bool, str]:
    ...
    try:
        if system == "Darwin":  # macOS
            ...
            return True, "Trae IDE closed (application path not found, please launch manually)"
