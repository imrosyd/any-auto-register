...
Registration flow:
  ...
  3. Wait for email verification code (6-digit) -> fill
  4. Fill password -> click "Sign Up"
  5. Wait for redirect to trae.ai home page
...
def _get_trae_cloudide_token(page, log_fn=print) -> tuple:
    ...
    try:
        log_fn("Getting Cloud-IDE JWT token...")
    ...
    # Ultimate fallback: decode id from JWT payload
