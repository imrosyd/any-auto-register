...
def trigger_validity_check(body: CheckRequest):
    """Manually trigger a batch account validity check."""
...
def trigger_token_refresh(body: RefreshRequest):
    """Manually trigger a batch token refresh."""
...
def trigger_expiry_warning(body: WarningRequest):
    """Manually trigger an expiry-warning scan."""
...
def lifecycle_status():
    """Return the lifecycle manager's running state."""
