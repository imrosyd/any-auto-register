...
# Install Python dependencies (includes Solver deps: patchright, quart, rich)
COPY requirements.txt ./
RUN pip install --no-cache-dir -r requirements.txt

# Install patchright/playwright browser (used by Solver)
...
# Remove .venv and frontend source
...
# APP_PASSWORD: set via -e APP_PASSWORD=xxx at runtime
# No password protection if unset (suitable for local use)
ENV APP_PASSWORD=""
