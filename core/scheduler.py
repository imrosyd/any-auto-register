"""Periodic task scheduler - account validity checks, trial expiry reminders"""
...
class Scheduler:
    ...
    def check_trial_expiry(self):
        """Check for expired trial accounts and update their status"""
        ...
        with Session(engine) as s:
            ...
            s.commit()
            if updated:
                print(f"[Scheduler] {updated} trial accounts have expired")
