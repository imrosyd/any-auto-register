...
def insecure_request(request_callable, *args, **kwargs) -> Any:
    """Execute a requests call with verify=False and suppress the associated warning."""
...
def mark_session_insecure(session: Any) -> Any:
    """
    Mark a requests.Session as verify=False; callers should pair with suppress_insecure_request_warning.
